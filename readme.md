...
# Application pour filtrer, télécharger et visualiser les données Alouette-I (English follows)
...
![interface de l'application](appinterface_fr.PNG)
...
## Version
Ceci est la v1.0 de l'application Alouette.
...
# Application to filter, download and visualize Alouette-I data (le français précède)
...
![app interface](appinterface_en.PNG)
...
- Create a folder named "data" and add the file "final_alouette_data.csv" (available [here](https://donnees-data.asc-csa.gc.ca/users/OpenData_DonneesOuvertes/pub/AlouetteData/final_alouette_data.csv)).
- You will also have to add the "config.cfg" file to the same folder as the "alouette.py" file. CSA employees can find this file on [Livelink](http://livelink/livelink/llisapi.dll?func=ll&objId=36908608&objAction=browse&viewType=1). If you are not a CSA employee, you will need to create your own config.cfg file. The format is as follows:

----
[TOKENS]
SECRET_KEY =
ALOUETTE_MAPBOX_TOKEN =
SCISAT_MAPBOX_TOKEN =
----

Where SECRET_KEY is your Flask secret key - ie. any string of random characters. This can be generated using the secrets library, for example: secret_key = secrets.token_urlsafe(16). Both ALOUETTE_MAPBOX_TOKEN and SCISAT_MAPBOX_TOKEN are mapbox access tokens. More information about how to generate these tokens is available here: https://docs.mapbox.com/help/getting-started/access-tokens//. These will require a free user account.   
...
## Navigation and files
 ...
 - alouette.py is the main application where each component and the layout of the application is defined
...
## Version
This is v1.0 of the Alouette app.
