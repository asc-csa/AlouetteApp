...
def update_ionograms_text(start_date, end_date, lat_min, lat_max, lon_min, lon_max, ground_stations=None, satellites=None):
    ...
    return "{:n}".format(dff.shape[0]) + " / " + "{:n}".format(701534)
...
def translate_static(x):
    ...
    return [
                ...
                _("Minimum longitude"),
                _("Maximum longitude"),
                _("Map of the world showing ground stations. Each station is represented by a circle, the size of which depends on the number of ionograms at each station. Each satellite is represented by a different color (Alouette 1: grey [1], ISIS 1: yellow [2], ISIS 2: red [3])."),
                _("Filter by date:"),
                ...
                _("Select x-axis:"),
                _("Select y-axis:"),
                _("Map showing either minimum frequency or maximum depth values at each ground station. Each station is represented by a circle, the size of which depends on either the mean or median values of the variables selected. Each satellite is represented by a different color (Alouette 1: grey [1], ISIS 1: yellow [2], ISIS 2: red [3]). Explore the data by selecting different variables in the drop-down menu on the right."),
                _("Select statistic:"),
