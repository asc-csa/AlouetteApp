...
def translate_static(x):
    ...
    return [
                ...
                _("Minimum longitude"),
                _("Maximum longitude"),
                _("Map of the world showing ground stations. Each station is represented by a circle, the size of which depends on the number of ionograms at each station. Each satellite is represented by a different color (Alouette 1: blue, ISIS 1: brown, ISIS 2: khaki)."),
                _("Filter by date:"),
                ...
                _("Select x-axis:"),
                _("Select y-axis:"),
                _("Map showing either minimum frequency or maximum depth values at each ground station. Each station is represented by a circle, the size of which depends on either the mean or median values of the variables selected. Each satellite is represented by a different color (Alouette 1: blue, ISIS 1: brown, ISIS 2: khaki). Explore the data by selecting different variables in the drop-down menu on the right."),
                _("Select statistic:"),
